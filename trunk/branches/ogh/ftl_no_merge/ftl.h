...
#define DRAM_BYTES_OTHER	((NUM_COPY_BUFFERS + NUM_FTL_BUFFERS + NUM_HIL_BUFFERS + NUM_TEMP_BUFFERS) * BYTES_PER_PAGE + SCAN_LIST_BYTES + SMT_DRAM_BYTES)
...
#define SMT_ADDR		(SCAN_LIST_ADDR + SCAN_LIST_BYTES)
